...
class TangoStyle(Style):
    ...
    styles = {
        ...
        # because special names such as Name.ClassStream, Name.Function, etc.
        ...
        Name.ClassStream:                "#000000",        # class: 'nc' - to be revised
        ...
        Name.Variable.ClassStream:       "#000000",        # class: 'vc' - to be revised
