...
class KalLexer(RegexLexer):
    ...
    tokens = {
        ...
        'classdef': [
            ...
            (r'([$a-zA-Z_][\w$]*)(?=\s*\n)', Name.ClassStream, '#pop'),
            (r'[$a-zA-Z_][\w$]*\b', Name.ClassStream),
            include('commentsandwhitespace'),
        ],
        'listcomprehension': [
            (r'\]', Punctuation, '#pop'),
...
class DartLexer(RegexLexer):
    ...
    tokens = {
        ...
        'class': [
            (r'[a-zA-Z_$]\w*', Name.ClassStream, '#pop')
        ],
        'import_decl': [
            include('string_literal'),
            (r'\s+', Whitespace),
...
class LassoLexer(RegexLexer):
    ...
    tokens = {
        ...
        'lasso': [
            ...
            (r"(\.)(\s*)('[a-z_][\w.]*')",
                bygroups(Name.Builtin.Pseudo, Whitespace, Name.Variable.ClassStream)),
            (r"(self)(\s*)(->)(\s*)('[a-z_][\w.]*')",
                bygroups(Name.Builtin.Pseudo, Whitespace, Operator, Whitespace,
                    Name.Variable.ClassStream)),
            (r'(\.\.?)(\s*)([a-z_][\w.]*(=(?!=))?)',
    ...
    tokens = {
        ...
        'classname': [
            ...
            (r'([a-zA-Z_]\w*)(' + _ws + r':' + _ws +
             r')([a-zA-Z_]\w*)?',
             bygroups(Name.ClassStream, using(this), Name.ClassStream), '#pop'),
            # interface definition for a category
            (r'([a-zA-Z_]\w*)(' + _ws + r'\()([a-zA-Z_]\w*)(\))',
             bygroups(Name.ClassStream, using(this), Name.Label, Text), '#pop'),
            # simple interface / implementation
            (r'([a-zA-Z_]\w*)', Name.ClassStream, '#pop'),
        ],
        'forward_classname': [
            (r'([a-zA-Z_]\w*)(\s*)(,)(\s*)',
             bygroups(Name.ClassStream, Whitespace, Text, Whitespace), '#push'),
            (r'([a-zA-Z_]\w*)(\s*)(;?)',
             bygroups(Name.ClassStream, Whitespace, Text), '#pop'),
        ],
        'function_signature': [
            include('whitespace'),
...
class MaskLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'([\w-]+)', Name.Tag, 'node'),
            (r'([^.#;{>\s]+)', Name.ClassStream, 'node'),
            (r'(#[\w-]+)', Name.Function, 'node'),
            (r'(\.[\w-]+)', Name.Variable.ClassStream, 'node')
        ],
        'string-base': [
            (r'\\.', String.Escape),
        ...
        'node': [
            (r'\s+', Whitespace),
            (r'\.', Name.Variable.ClassStream, 'node-class'),
...
class EarlGreyLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'''(?x)
                (?:()([a-zA-Z$_](?:[\w$\-]*[\w$])?)|
                   (?<=[\s{\[(])(\.)([a-zA-Z$_](?:[\w$\-]*[\w$])?))
                (?=.*%)''',
             bygroups(Punctuation, Name.Tag, Punctuation, Name.ClassStream.Start), 'dbs'),
        ...
        'dbs': [
            (r'(\.)([a-zA-Z$_](?:[\w$\-]*[\w$])?)(?=[.\[\s])',
             bygroups(Punctuation, Name.ClassStream.DBS)),
            (r'(\[)([\^#][a-zA-Z$_](?:[\w$\-]*[\w$])?)(\])',
