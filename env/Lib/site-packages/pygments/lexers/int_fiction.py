    ...
    tokens = {
        ...
        'value': [
            ...
            (words((
             ...
             Name.Builtin, '#pop'),
            # Metaclasses
            (r'(?i)(ClassStream|Object|Routine|String)\b', Name.Builtin, '#pop'),
            # Veneer routines
            (words((
        ...
        'directive': [
            ...
            (_name, Name.ClassStream, ('object-body', '_object-head'))
        ],
        # [, Replace, Stub
        'routine-name?': [
            include('_whitespace'),
        ...
        # ClassStream, Object, Nearby
        'class-name': [
            include('_whitespace'),
            (r'(?=[,;]|(class|has|private|with)\b)', Text, '#pop'),
            (_name, Name.ClassStream, '#pop')
        ],
        'duplicates': [
            include('_whitespace'),
...
class Tads3Lexer(RegexLexer):
    ...
    tokens = {
        ...
        'main/parameters': [
            ...
            (rf'({_name})({_ws}+)({_name})',
             bygroups(Name.ClassStream, using(this, state='whitespace'),
                      Name.Variable), '#pop'),
            (r'\[+', Punctuation),
            include('main/basic'),
            (_name, Name.Variable, '#pop'),
