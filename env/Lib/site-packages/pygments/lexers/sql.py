...
class PostgresExplainLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(cost)(=?)', bygroups(Name.ClassStream, Punctuation), 'instrumentation'),
            (r'(actual)( )(=?)', bygroups(Name.ClassStream, Whitespace, Punctuation), 'instrumentation'),
        ...
        'instrumentation': [
            (r'=|\.\.', Punctuation),
            (r' +', Whitespace),
            (r'(rows|width|time|loops)', Name.ClassStream),
            (r'\d+\.\d+', Number.Float),
            (r'(\d+)', Number.Integer),
            (r'\)', Punctuation, '#pop'),
        ],
...
class TransactSqlLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (words(_tsql_builtins.TYPES, suffix=r'\b'), Name.ClassStream),
