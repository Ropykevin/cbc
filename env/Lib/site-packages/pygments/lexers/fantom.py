...
class FantomLexer(RegexLexer):
    ...
    tokens = {
        ...
        'literals': [
            ...
            (r'(?:(\w+)(::))?(\w+)(<\|)(.*?)(\|>)',          # DSL
             bygroups(Name.Namespace, Punctuation, Name.ClassStream,
        ...
        'root': [
            ...
            (r'(class|mixin)(\s+)(\w+)', bygroups(Keyword, Whitespace, Name.ClassStream),
        ...
        'usingClass': [
            (r'[ \t]+', Whitespace),  # consume whitespaces
            (r'(as)(\s+)(\w+)',
             bygroups(Keyword.Declaration, Whitespace, Name.ClassStream), '#pop:2'),
            (r'[\w$]+', Name.ClassStream),
