...
class CleanLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        'import.module.as': [
            include('whitespace'),
            (lowerId, Name.ClassStream, '#pop'),
            (upperId, Name.ClassStream, '#pop'),
        ],
        'import.what': [
            (r'\b(class)\b(\s+)(' + classId + r')',
                bygroups(Keyword, Whitespace, Name.ClassStream), 'import.what.class'),
            (r'\b(instance)(\s+)(' + classId + r')(\s+)',
                bygroups(Keyword, Whitespace, Name.ClassStream, Whitespace), 'import.what.instance'),
            (r'(::)(\s*)\b(' + upperId + r')\b',
                bygroups(Punctuation, Whitespace, Name.ClassStream), 'import.what.type'),
        ...
        'delimiters': [
            (r'[,;(){}\[\]]', Punctuation),
            (r'(\')([\w`.]+)(\')',
                bygroups(Punctuation, Name.ClassStream, Punctuation)),
        ],
        'names': [
            (lowerId, Name),
            (scoreLowerId, Name),
            (funnyId, Name.Function),
            (upperId, Name.ClassStream),
            (scoreUpperId, Name.ClassStream),
        ]
    }
