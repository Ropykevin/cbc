...
class TypoScriptHtmlDataLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            # INCLUDE_TYPOSCRIPT
            (r'(INCLUDE_TYPOSCRIPT)', Name.ClassStream),
    ...
    tokens = {
        ...
        'keywords': [
            ...
            (r'(?=[\w\-])(CASE|CLEARGIF|COA|COA_INT|COBJ_ARRAY|COLUMNS|CONTENT|'
             ...
             r'TEMPLATE|TEXT|USER|USER_INT)(?![\w\-])', Name.ClassStream),
            # Menu states
            (r'(?=[\w\-])(ACTIFSUBRO|ACTIFSUB|ACTRO|ACT|CURIFSUBRO|CURIFSUB|CURRO|'
             ...
             r'USRRO|USR)', Name.ClassStream),
            # Menu objects
            (r'(?=[\w\-])(GMENU_FOLDOUT|GMENU_LAYERS|GMENU|IMGMENUITEM|IMGMENU|'
             r'JSMENUITEM|JSMENU|TMENUITEM|TMENU_LAYERS|TMENU)', Name.ClassStream),
            # PHP objects
            (r'(?=[\w\-])(PHP_SCRIPT(_EXT|_INT)?)', Name.ClassStream),
        ...
        'html': [
            ...
            (r'(?s)(_CSS_DEFAULT_STYLE)(\s*)(\()(.*(?=\n\)))',
             bygroups(Name.ClassStream, Text, String.Symbol, using(TypoScriptCssDataLexer))),
        ],
        'literal': [
