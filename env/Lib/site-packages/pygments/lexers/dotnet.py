...
class VbNetLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(?<!\.)(ClassStream|Structure|Enum)(\s+)',
        ...
        'end': [
            (r'\s+', Whitespace),
            (r'(Function|Sub|Property|ClassStream|Structure|Enum|Module|Namespace)\b',
             Keyword, '#pop'),
            default('#pop'),
        ]
    }
...
class FSharpLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'\b(type)(\s+)(\w+)',
             bygroups(Keyword, Whitespace, Name.ClassStream)),
    ...
    tokens = {
        'root': [
            ...
            (r'^([ \t]*)((?:' + XPP_CHARS + r'(?:\[\])?\s+)+?)'  # return type
                ...
                bygroups(Whitespace, using(this), Name.Function, Whitespace,
                        Punctuation)),
            (r'^(\s*)(\[)([^\n]*?)(\])', bygroups(Whitespace, Name.Attribute, Name.Variable.ClassStream, Name.Attribute)),
            (r'[^\S\n]+', Whitespace),
            (r'(\\)(\n)', bygroups(Text, Whitespace)),  # line continuation
            (r'//[^\n]*?\n', Comment.Single),
            (r'/[*][^\n]*?[*]/', Comment.Multiline),
