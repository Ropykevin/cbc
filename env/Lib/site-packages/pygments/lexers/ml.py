...
class SMLLexer(RegexLexer):
    ...
    tokens = {
        ...
        'datbind': [
            ...
            (rf'(\|)(\s*)({alphanumid_re})',
             bygroups(Punctuation, Text, Name.ClassStream)),
            (rf'(\|)(\s+)({symbolicid_re})',
             bygroups(Punctuation, Text, Name.ClassStream)),
        ...
        'ename': [
            ...
            (rf'(and\b)(\s+)({alphanumid_re})',
             bygroups(Keyword.Reserved, Text, Name.ClassStream)),
            (rf'(and\b)(\s*)({symbolicid_re})',
             bygroups(Keyword.Reserved, Text, Name.ClassStream)),
            (r'\b(of)\b(?!\')', Keyword.Reserved),
            (rf'({alphanumid_re})|({symbolicid_re})', Name.ClassStream),
        ...
        'datcon': [
            include('whitespace'),
            (rf'({alphanumid_re})', Name.ClassStream, '#pop'),
            (rf'({symbolicid_re})', Name.ClassStream, '#pop'),
            (r'\S+', Error, '#pop'),
        ],
