    ...
    tokens = {
        'root': [
            ...
            (rf'\b(New)\b([ \t]?)([(]?)({bmax_name})',
             bygroups(Keyword.Reserved, Whitespace, Punctuation, Name.ClassStream)),
            ...
            (bmax_func, bygroups(Name.Function, Whitespace, Keyword.Type,
                                 ...
                                 Keyword.Type, Name.ClassStream, Whitespace,
            ...
            (bmax_var, bygroups(Name.Variable, Whitespace, Keyword.Type, Operator,
                                ...
                                Name.ClassStream, Whitespace, Keyword.Type)),
            (rf'\b(Type|Extends)([ \t]+)({bmax_name})',
             bygroups(Keyword.Reserved, Whitespace, Name.ClassStream)),
            # Keywords
    ...
    tokens = {
        'root': [
            ...
            (rf'\b(Object)\b([ \t]*)([.])([ \t]*)({bb_name})\b',
             bygroups(Operator, Whitespace, Punctuation, Whitespace, Name.ClassStream)),
            (rf'\b{bb_var}\b([ \t]*)(\()',
             bygroups(Name.Function, Whitespace, Keyword.Type, Whitespace, Punctuation,
                      Whitespace, Name.ClassStream, Whitespace, Punctuation)),
            (rf'\b(Function)\b([ \t]+){bb_var}',
             bygroups(Keyword.Reserved, Whitespace, Name.Function, Whitespace, Keyword.Type,
                      Whitespace, Punctuation, Whitespace, Name.ClassStream)),
            (rf'\b(Type)([ \t]+)({bb_name})',
             bygroups(Keyword.Reserved, Whitespace, Name.ClassStream)),
            # Keywords
...
class MonkeyLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(?i)(New|ClassStream|Interface|Extends|Implements)(\s+)',
        ...
        'classname': [
            ...
            (rf'{name_class}\b', Name.ClassStream),
            # array (of given size)
            (r'(\[)(\s*)(\d*)(\s*)(\])',
