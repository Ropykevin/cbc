    ...
    tokens = {
        'root': [
            ...
            (r'(endclass\b)(?:(\s*)(:)(\s*)([a-zA-Z_]\w*))?',
             bygroups(Keyword.Declaration, Whitespace, Punctuation, Whitespace, Name.ClassStream)),
    ...
    tokens = {
        'root': [
            ...
            (r'(architecture|configuration)(\s+)([a-z_]\w*)(\s+)'
             r'(of)(\s+)([a-z_]\w*)(\s+)(is)',
             bygroups(Keyword, Whitespace, Name.ClassStream, Whitespace, Keyword, Whitespace,
                      Name.ClassStream, Whitespace, Keyword)),
            (r'([a-z_]\w*)(:)(\s+)(process|for)',
             bygroups(Name.ClassStream, Operator, Whitespace, Keyword)),
